...
public class AnalogController extends View {
    ...
    void init() {
        ...
        circlePaint.setColor(getResources().getColor(R.color.baseProgress));
        circlePaint.setStyle(Paint.Style.FILL);
        circlePaint2 = new Paint();
//        circlePaint2.setColor(getResources().getColor(R.color.baseProgress));
        circlePaint2.setColor(Color.parseColor("#FFA036"));
        circlePaint2.setStyle(Paint.Style.FILL);
        linePaint = new Paint();
        linePaint.setColor(getResources().getColor(R.color.baseProgress));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(midx, midy, x2, y2, linePaint);
